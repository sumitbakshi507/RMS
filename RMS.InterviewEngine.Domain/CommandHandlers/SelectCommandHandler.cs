...
{
    public class SelectCommandHandler : IRequestHandler<SelectCommand, bool>
    {
        private readonly IEventBus _bus;

        public SelectCommandHandler(IEventBus bus)
        {
            _bus = bus;
        }

        public Task<bool> Handle(SelectCommand request, CancellationToken cancellationToken)
        {
